        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="categories__item set-bg"
                    data-setbg=<?=get_theme_file_uri('assets/img/categories/cat-1.jpg')?>>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="categories__item set-bg"
                    data-setbg=<?=get_theme_file_uri('assets/img/categories/cat-2.jpg')?>>
                    <div class="categories__hover__text">
                        <h5>Dinner</h5>
                        <p>28 articles</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="categories__item set-bg"
                    data-setbg=<?=get_theme_file_uri('assets/img/categories/cat-3.jpg')?>>
                    <div class="categories__hover__text">
                        <h5>Dinner</h5>
                        <p>28 articles</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="categories__item set-bg"
                    data-setbg=<?=get_theme_file_uri('assets/img/categories/cat-4.jpg')?>>
                    <div class="categories__hover__text">
                        <h5>Dinner</h5>
                        <p>28 articles</p>
                    </div>
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="categories__post__item categories__post__item--large">
                        <div class="categories__post__item__pic set-bg"
                            data-setbg=<?=get_theme_file_uri('assets/img/categories/categories-post/cp-1.jpg')?>>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="categories__post__item">
                                <div class="categories__post__item__pic small__item set-bg"
                                    data-setbg=<?=get_theme_file_uri('assets/img/categories/categories-post/cp-2.jpg')?>>
                                    <div class="post__meta">
                                        <h4>08</h4>
                                        <span>Aug</span>
                                    </div>
                            ...
                            <div class="categories__post__item">
                                <div class="categories__post__item__pic set-bg"
                                    data-setbg=<?=get_theme_file_uri('assets/img/categories/categories-post/cp-4.jpg')?>>
                                    <div class="post__meta">
                                        <h4>08</h4>
                                        <span>Aug</span>
                                    </div>
                            ...
                            <div class="categories__post__item__plain set-bg"
                                data-setbg=<?=get_theme_file_uri('assets/img/categories/categories-post/cp-6.jpg')?>>
                                <div class="categories__post__item__text">
                                    <div class="post__meta">
                                        <h4>08</h4>
                                        <span>Aug</span>
                            ...
                            <div class="categories__post__item">
                                <div class="categories__post__item__pic smaller__large set-bg"
                                    data-setbg=<?=get_theme_file_uri('assets/img/categories/categories-post/cp-8.jpg')?>>
                                    <div class="post__meta">
                                        <h4>08</h4>
                                        <span>Aug</span>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="categories__post__item">
                                <div class="categories__post__item__pic smaller__large set-bg"
                                    data-setbg=<?=get_theme_file_uri('assets/img/categories/categories-post/cp-3.jpg')?>>
                                    <div class="post__meta">
                                        <h4>08</h4>
                                        <span>Aug</span>
                                    </div>
                            ...
                            <div class="categories__post__item__small">
                                <img src=<?=get_theme_file_uri('assets/img/categories/categories-post/quote.png')?>
                                    alt="">
                            ...
                            <div class="categories__post__item">
                                <div class="categories__post__item__pic smaller__large set-bg"
                                    data-setbg=<?=get_theme_file_uri('assets/img/categories/categories-post/cp-5.jpg')?>>
                                    <div class="post__meta">
                                        <h4>08</h4>
                                        <span>Aug</span>
                                    </div>
                            ...
                            <div class="categories__post__item">
                                <div class="categories__post__item__pic set-bg"
                                    data-setbg=<?=get_theme_file_uri('assets/img/categories/categories-post/cp-7.jpg')?>>
                                    <div class="post__meta">
                                        <h4>08</h4>
                                        <span>Aug</span>
                                    </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="sidebar__item">
                        <div class="sidebar__about__item">
                            ...
                            <img src=<?=get_theme_file_uri('assets/img/sidebar/sidebar-about.jpg')?> alt="">
                        ...
                        <div class="sidebar__feature__item">
                            ...
                            <div class="sidebar__feature__item__large set-bg"
                                data-setbg=<?=get_theme_file_uri('assets/img/sidebar/feature-post.jpg')?>>
                        ...
                        <div class="sidebar__item__banner">
                            <img src=<?=get_theme_file_uri('assets/img/sidebar/banner.jpg')?> alt="">
                        </div>
