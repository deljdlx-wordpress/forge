                ...
                <div class="row">
                    <div class="col-lg-6 p-0">
                        <div class="hero__inside__item hero__inside__item--wide set-bg"
                            data-setbg=<?=get_theme_file_uri('assets/img/hero/hero-1.jpg')?>>
                    ...
                    <div class="col-lg-3 col-md-6  p-0">
                        <div class="hero__inside__item hero__inside__item--small set-bg"
                            data-setbg=<?=get_theme_file_uri('assets/img/hero/hero-2.jpg')?>>
                            <div class="hero__inside__item__text">
                                <div class="hero__inside__item--meta">
                                    <span>08</span>
                                    <p>Aug</p>
                        ...
                        <div class="hero__inside__item hero__inside__item--small set-bg"
                            data-setbg=<?=get_theme_file_uri('assets/img/hero/hero-3.jpg')?>>
                            <div class="hero__inside__item__text">
                                <div class="hero__inside__item--meta">
                                    <span>08</span>
                                    <p>Aug</p>
                    ...
                    <div class="col-lg-3 col-md-6  p-0">
                        <div class="hero__inside__item set-bg"
                            data-setbg=<?=get_theme_file_uri('assets/img/hero/hero-4.jpg')?>>
                            <div class="hero__inside__item__text">
                                <div class="hero__inside__item--meta">
                                    <span>08</span>
                                    <p>Aug</p>
